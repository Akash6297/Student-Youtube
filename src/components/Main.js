...
//       setTodoVisible(false); // Hide To-Do content when showing Calculator
//       setNoteVisible(false); // Hide Note content when showing Calculator
//     };
...
//       <div
//         className={`floating-icon calculator-icon ${calculatorVisible ? 'active' : ''}`}
...
//       {/* Calculator content */}
//       {calculatorVisible && (
//         <div className="floating-content calculator-content">
